...
- Published to crates.io (`cargo install gateway-poc`)
...
- Pre-built binary download instructions in README
- Linux x86_64 binary to all releases
- Consistent binary naming (`gateway-poc-linux-amd64`, `gateway-poc-darwin-arm64`)
...
[Unreleased]: https://github.com/hephaex/k8s_vGateway/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/hephaex/k8s_vGateway/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/hephaex/k8s_vGateway/compare/v0.1.2...v0.1.3
